    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Character, Integer> entry : charMap.entrySet()) {
            if (entry.getValue() == minCount) {
                System.out.println("Мin кол-во повторений у символа " + entry.getKey() + " - втстречается " + entry.getValue() + " раз(a)");
            }
        }
        ...
        for (Map.Entry<Character, Integer> entry : charMap.entrySet()) {
            if (entry.getValue() == maxCount) {
                System.out.println("Маx кол-во повторений у символа " + entry.getKey() + " - встречается " + entry.getValue() + " раз(a)");
            }
        }
    }
}
